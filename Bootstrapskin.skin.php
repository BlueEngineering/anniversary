...
<div id="userbar" class="bg-cyan">
  <div class="body">
	...
	<ul>
	<li><a href="index.php?title=Install_Guide">Installation</a></li>
        <li aria-haspopup="true"><a href="#">Guides A - H</a>
	<div class="grid-container3">
	<ul>
	<li><a href="index.php?title=Alerts">Alerts</a></li>
        <li><a href="index.php?title=Badges">Badges</a></li>
	<li><a href="index.php?title=Breadcrumbs">Breadcrumbs</a></li>
	<li><a href="index.php?title=Buttons">Buttons</a></li>
	<li><a href="index.php?title=Button_dropdown">Button Drop</a></li>
        <li><a href="index.php?title=Drp_Menu">Drop Menu</a></li>
        <li><a href="index.php?title=Grid_System">Grid System</a></li>
        <li><a href="index.php?title=Helper_Classes">Helper Classes</a></li>
        </ul>       
        </div>
	</li>
	<li aria-haspopup="true"><a href="#">Guides J - P</a>
	<div class="grid-container3">
	<ul>
	<li><a href="index.php?title=Jumbotron">Jumbotron</a></li>
        <li><a href="index.php?title=Labels">Lables</a></li>
	<li><a href="index.php?title=Lists">Lists</a></li>
        <li><a href="index.php?title=Nav_Bar">Nav Bar</a></li>
        <li><a href="index.php?title=Navs">Navs</a></li>
	<li><a href="index.php?title=Pagination">Pagination</a></li>
	<li><a href="index.php?title=Panels">Panels</a></li>
        <li><a href="index.php?title=Page_Header">Page Header</a></li>
	</ul>
	</div>
	</li>
        <li aria-haspopup="true"><a href="#">Guides R - W</a>
	<div class="grid-container3">
	<ul>
	<li><a href="index.php?title=Responsive">Responsive</a></li>
        <li><a href="index.php?title=Tables">Tables</a></li>
	<li><a href="index.php?title=Typography">Typography</a></li>
        <li><a href="index.php?title=Wells">Wells</a></li>
	</ul>
	</div>
	</li>							
	<li aria-haspopup="true"><a href="#">Other</a>
	<div class="grid-container3">
	<ul>
	<li><a href="index.php?title=Font_Awesome">Font Awesome</a></li>
        <li><a href="index.php?title=Options">Other Options</a></li>
        <li><a href="index.php?title=Adding_Classes">Adding Classes</a></li>
	<li><a href="index.php?title=Support">Support Changes</a></li>
	</ul>
	</div>
	</li>						</ul>
					</div>
        ...
        <li style="margin-top:7px;"><?php $this->renderNavigation( array( 'EDIT' ) );?></li>
